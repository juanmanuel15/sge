    ...
    <div class="container">
        ...
        <div class="row d-flex justify-content-center">
                <div class="col-xl-6 col-sm-12">
                    <h4 class="d-flex justify-content-center mt-4 "><b>Constancias de colaboradores</b></h4>
                </div>  
        </div>
        ...
        <div class="row mt-4 d-flex justify-content-center">
            <div class="col-lg-8 col-sm-10">
                <form id="form_buscarColaborador">
                    <div class="input-group d-flex justify-content-center">
                        <input id="buscar_Colaborador" type="text" class="form-control col-sm-auto" name="txt_buscar" placeholder="Buscar">
        ...
        <script src = "../../../../js/admin/reporte-usuario/colaborador/main.js"></script>
        <script src = "../../../../js/admin/reporte-usuario/colaborador/vistas.js"></script>
