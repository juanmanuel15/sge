...
<div class="modal fade" id="modal_agregar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <form action = "" method="post" id ="formtActividad">       
        ...
        <div class="form-group row d-flex justify-content-center">
            <div class="col-md-2 col-sm-12 modal_estilo">
                <label for="txt_tActividad" class="col-form-label">Nombre:</label>                
            </div>
            <div class="col-md-10 col-sm-12">
                <input type="text" class="form-control" id="txt_tActividad">
            </div>
...
<body>
    ...
    <div class="row">
        <div class="col-xl-12 col-sm-12">
                <h3 class="d-flex justify-content-center mt-4"><b>Tipo de Actividad</b></h3>
        </div>  
    </div>
    ...
    <div class="row mt-5">
            ...
            <table class="table text-center">
                <thead class = "text_tabla">
                    <tr>
                        ...
                        <th class="text-left"><span data-toggle="modal" data-target="#modal_agregar" id ="btn_agregar"><i class="fas fa-plus i_mostrar"></i></span></th>
                    </tr>
                
                </thead>
                <tbody class="text_tabla " id="tablaTActividad">
                </tbody>
      ...
      <script src="../../js/tActividad.js"></script>
